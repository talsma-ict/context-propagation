 ...
 */
package nl.talsmasoftware.context.tests.j8.locale;
...
class Java8LocalePropagatorTest {
    ...
    void testLocalePropagation(String locale) throws InterruptedException {
        ...
        // when
        final Locale result = Java8LocalePropagator.getPropagatedLocaleFromNewThread();
